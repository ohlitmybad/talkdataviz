...
def save_uploaded_file():
    ...
    agent = create_pandas_dataframe_agent(ChatOpenAI(model_name='gpt-3.5-turbo-0613', temperature=0.2, openai_api_key=openai_api_key), df, return_intermediate_steps=True,
